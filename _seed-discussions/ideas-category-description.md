# Ideas category description (paste into the category's description field)

> Paste the block below into **Settings → Discussions → categories → Ideas → Description**.
> Keep it short — GitHub shows this above the new-discussion form.

---

💡 **Propose a feature and let the community vote.** Share what would make Label Alchemy more useful
for your Salesforce work — one idea per post.
